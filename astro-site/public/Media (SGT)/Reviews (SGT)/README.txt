Place reviewer avatar images here using the same filenames as the CSV:

  reviewer-01.png  Harold Swanson   (also on homepage)
  reviewer-02.png  Joshua Hurst     (also on homepage)
  reviewer-03.png  Alex Botardo     (also on homepage)
